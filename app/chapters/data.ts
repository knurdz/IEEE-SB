...
export const societies: Society[] = [
  ...
  },
  {
    ...
    title: 'Information Theory Society',
    description: 'Advancing the science of information processing and communication. IT Society members work on coding theory, data compression, cryptography, and the fundamental limits of information transmission that underlie modern digital communications.',
    logo: '/chapters/1.png',
    links: {
      website: '#',
      instagram: '#',
