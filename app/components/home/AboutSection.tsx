...
export default function AboutSection() {
  ...
  return (
    ...
    >
      ...
      <div ref={ref} className="max-w-5xl mx-auto px-6 lg:px-8 relative z-10 flex flex-col items-center">
        <div className="text-center font-medium leading-normal md:leading-relaxed text-xl md:text-2xl lg:text-[1.75rem] max-w-4xl tracking-tight text-slate-800">
          At the IEEE Student Branch of the University of Moratuwa, we believe our journey is more than just reaching a destination—it&apos;s about the technical excellence and leadership you cultivate along the way. Whether you&apos;re seeking innovation, professional growth, <span className="text-slate-400">or community immersion, we design initiatives around what truly empowers the next generation of tech leaders.</span>
        </div>
