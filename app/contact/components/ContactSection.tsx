...
export default function ContactSection() {
  return (
    <section className="relative w-full min-h-screen bg-white overflow-hidden py-24 lg:py-32 px-4 md:px-0 [@media(min-width:48rem)_and_(max-width:64rem)_and_(orientation:portrait)]:px-8" id="contact">
