...
export default function EventDetailPageClient({ params }: EventPageProps) {
  ...
  const hasSocials = event.facebookUrl || event.instagramUrl || event.linkedinUrl || event.whatsappUrl || event.websiteUrl;
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-12">
              ...
              {hasSocials && (
                <motion.div
                  className="flex items-center gap-2 md:gap-4 mb-8 flex-nowrap overflow-x-auto no-scrollbar"
                ...
                >
                  {event.websiteUrl && (
                    <a
                      ...
                      className="inline-flex items-center gap-1.5 md:gap-2 px-3.5 md:px-6 py-2 md:py-3 rounded-full bg-primary text-white font-orbitron text-[0.625rem] md:text-sm font-bold transition-all hover:shadow-[0_0_20px_rgba(0,87,157,0.3)] hover:-translate-y-1 group shrink-0"
                    >
                      <Globe className="w-3.5 h-3.5 md:w-[18px] md:h-[18px] transition-transform group-hover:rotate-12" />
                  ...
                  <div className="flex items-center gap-2 md:gap-3 shrink-0">
                    {event.facebookUrl && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="p-2 md:p-3 rounded-full bg-primary/5 hover:bg-primary/10 text-primary transition-all duration-300 hover:-translate-y-1 flex items-center justify-center border border-primary/10 shadow-sm"
                        title="Facebook"
                      >
                        <Image src="/social/FB.svg" alt="Facebook" width={20} height={20} className="w-4 h-4 md:w-[22px] md:h-[22px] opacity-80 group-hover:opacity-100" />
                      </a>
                    )}
                    {event.linkedinUrl && (
                      <a
                        ...
                        title="LinkedIn"
                      >
                        <Image src="/social/Linkdin.svg" alt="LinkedIn" width={20} height={20} className="w-4 h-4 md:w-[22px] md:h-[22px] opacity-80 group-hover:opacity-100" />
                      </a>
                    )}
                    {event.instagramUrl && (
                      <a
                        ...
                        title="Instagram"
                      >
                        <Image src="/social/Insta.svg" alt="Instagram" width={20} height={20} className="w-4 h-4 md:w-[22px] md:h-[22px] opacity-80 group-hover:opacity-100" />
                      </a>
                    )}
                    {event.whatsappUrl && (
                      <a
                        ...
                        title="WhatsApp"
                      >
                        <Image src="/social/Whatsapp.svg" alt="WhatsApp" width={20} height={20} className="w-4 h-4 md:w-[22px] md:h-[22px] opacity-80 group-hover:opacity-100" />
                      </a>
                    )}
                  </div>
                </motion.div>
