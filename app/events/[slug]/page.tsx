          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-12">
              <div className="flex items-center gap-4 mb-6">
                <span 
                  className="px-4 py-1.5 rounded-full text-[12px] font-bold tracking-widest uppercase font-display"
                  style={{
                ...
                <span className="text-muted font-medium">{event.year}</span>
              </div>
              ...
              <p className="text-accent font-medium italic text-lg mb-8">{event.date}</p>
            </div>
